...
public class TransferDao {
	public void transferOut(Connection con,String out,int money) throws SQLException {
	...
	public void transferIn(Connection con,String in ,int money) throws SQLException {
		QueryRunner qr = new QueryRunner();
		/*Connection con = null;
		con = DBUtil.getConnection();*/
